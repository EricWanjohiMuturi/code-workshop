<script setup>
import Yebo from '@/assets/wrapped/yebo.jpeg'
import Fein from '@/assets/wrapped/fein.jpeg'
import Sit from '@/assets/wrapped/sitting.jpeg'
import Cry from '@/assets/wrapped/cry.jpeg'
import Mission from  '@/assets/wrapped/mission.jpeg'
...
const songs =[
  {
    id: 1,
    song: 'Yebo[Nitawale]',
    artist: ['Vestine & Dorcas'],
    cover: Yebo,
  },
  {
    id: 2,
    song: 'Sitting Out Night Time',
    artist: ['Ruddy Thomas'],
    cover: Sit,
  },
  {
    id: 3,
    song: 'I Dont Want To See You Cry',
...
<template>
<div>
  <h3 class="font-medium text-2xl text-heading mt-8" data-aos="fade-up" data-aos-duration="1300">Spotify Wrapped 2025</h3>
  <div class="main border border-gray-200 shadow-lg shadow-[#3d5690]/30" data-aos="fade-up" data-aos-duration="1600">
    <div class="currentplaying">
      ...
      <p class="heading">Top Songs</p>
    </div>
    <div class="loader">
      <div class="song">
        <p class="name">FE!N</p>
        <p class="artist font-bold">Travis Scott, Playboi Carti</p>
      </div>
      <div class="albumcover rounded-lg">
        <img :src="Fein" class="rounded" alt="">
      </div>
      <div class="loading">
        <div class="load"></div>
        <div class="load"></div>
    ...
    >
      <div class="song">
        <p class="name">{{ song.song }}</p>
        <p class="artist font-bold">{{ song.artist.join(', ') }}</p>
      </div>
      <div class="albumcover">
        <img :src="song.cover" class="rounded" alt="">
      </div>
      <div class="play"></div>
    </div>
